...
contract Stake is Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) public rewards;
     ...
     //checks if the user has staked
     mapping(address=>bool) private isUserStaking;
    ...
    function isStaking(address owner) external nonReentrant returns (bool) {
        owner = msg.sender;
        return isUserStaking[msg.sender];
    }
